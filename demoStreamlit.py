# Source: https://github.com/ShivamBhirud/Capital-Bike-Share-Data-Streamlit-Web-Application
...
@st.cache
def loadData():
	df = pd.read_csv("https://raw.githubusercontent.com/bonchae/data/master/2010-capitalbikeshare-tripdata.csv")
	return df
...
@st.cache
def showMap():
	plotData = pd.read_csv("https://raw.githubusercontent.com/bonchae/data/master/Trip%20history%20with%20locations.csv")
	Data = pd.DataFrame()
